...
import pandas as pd
##################################################################################################
FILE_PATH = '/home/abdul_ahad/big_data_lab'
...
def process_and_filter_csv(files):    
    ...
    output_path = '/home/abdul_ahad/big_data_lab/'    
...
process_csv_task = PythonOperator(
    ...
    op_args=[f'{FILE_PATH}/{filename}' for filename in os.listdir('/home/abdul_ahad/big_data_lab') if filename.endswith('.csv')],    
    dag=dag,
)
...
compute_averages_task = PythonOperator(
    ...
    provide_context=True,
    op_args=[os.path.join('/home/abdul_ahad/big_data_lab/', 'output.txt'),
             os.path.join('/home/abdul_ahad/big_data_lab/', 'monthly_averages.txt')],
    dag=dag,
)
##################################################################################################
...
create_visualizations_task = PythonOperator(
    ...
    provide_context=True,
    op_args=[os.path.join('/home/abdul_ahad/big_data_lab/', 'monthly_averages.txt'),
             os.path.join('/home/abdul_ahad/big_data_lab/', 'visualizations')],
    dag=dag,
)
...
wait_for_archive_task >> check_and_unzip_task >> process_csv_task 
process_csv_task >> compute_averages_task >> create_visualizations_task >>  delete_csv_task