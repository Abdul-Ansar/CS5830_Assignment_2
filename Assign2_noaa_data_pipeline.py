...
fetch_page_task = BashOperator(
    task_id='fetch_page',
    bash_command=f'wget -O /home/abdul_ahad/page_fetch.html {BASE_URL}{YEAR}/',
    dag=dag,
)
...
def extract_csv_links():
    with open('/home/abdul_ahad/page_fetch.html', 'r', encoding='utf-8') as file:
...
place_archive_task = BashOperator(
    ...
    bash_command=f'mv /home/abdul_ahad/noaa_archive.zip {OUTPUT_PATH}',
    dag=dag,
)
